            ...
            <table class="w-full">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    <tr class="border-b border-gray-300 hover:bg-gray-100">
                        <td class="py-3 px-6 text-left whitespace-nowrap text-lg">1234</td>
                        <td class="py-3 px-6 text-left text-lg">Value</td>
                        <td class="py-3 px-6 text-left text-lg">John Doe</td>
                        <td class="py-3 px-6 text-left text-lg">2024-03-10 12:00:00</td>
                        <td class="py-3 px-6 text-left text-lg">
                            <button class="bg-purple-500 text-white px-4 py-2 rounded-md hover:bg-purple-600">Edit</button>
